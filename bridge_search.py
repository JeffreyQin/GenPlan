...
class BridgePOMCP():
    ...
    def __init__(self, generator, discount = 1.0, exploratio = 5.0, epsilon = 0.001, depth = 10, num_simulations = 1000):
        self.generator: BridgeGenerator = generator
        self.discount: float = discount
        self.c: float = exploration_steps
    ...
    def UCB1(self, node: BridgeNode, action: int, depth: int):
        """
